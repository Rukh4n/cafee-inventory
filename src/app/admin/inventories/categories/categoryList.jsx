...
export default function CategoryList({ category }) {
    ...
    // Effect untuk debounce
    useEffect(() => {
        const handler = setTimeout(() => {
            setDebouncedSearch(search);
        }, 500);

        return () => clearTimeout(handler); // clear timer saat mengetik lagi
    }, [search]);
    ...
    return (
        <div className="">
            <div className="flex flex-wrap items-center justify-left gap-3 mb-6">
                {/* 🔍 Search bar */}
                <div className="flex items-center gap-2  border border-[#D4C9BE] rounded-md px-3 py-2 bg-[#030303] w-full sm:max-w-sm">
                    ...
                    <input
                        ...
                        className="w-full bg-transparent outline-none text-sm px-2 py-1 text-[#F1EFEC] placeholder-[#8C857E]"
                    />
                </div>
            ...
            <div className="text-[#F1EFEC] p-4 bg-[#030303]">

...
export default function ItemsList({ item, category }) {
    ...
    return (
        <div className="bg-[#030303] min-h-screen text-[#F1EFEC] p-5">
                ...
                <table className="w-full border-2 border-[#D4C9BE] border-collapse">
                    <thead className="bg-[#1a1a1a] text-[#F1EFEC]">
                        <tr>
                            ...
                            <th className="p-3 border border-[#D4C9BE]">Nama Item</th>
                            <th className="p-3 border border-[#D4C9BE]">Kategori</th>
                            <th className="p-3 border border-[#D4C9BE]">Stok</th>
                            <th className="p-3 border border-[#D4C9BE]">Satuan</th>
                            <th className="p-3 border border-[#D4C9BE]">Aksi</th>
                        </tr>
                    </thead>
                    <tbody>
                        {item.length === 0 ? (
                            ...
                            item.map((item, index) => (
                                <tr key={item.id} className="hover:bg-[#1a1a1a] transition">
                                    <td className="p-2 border border-[#D4C9BE] text-center">{index + 1}</td>
                                    <td className="p-2 border border-[#D4C9BE]">{item.name}</td>
                                    <td className="p-2 border border-[#D4C9BE]">{getNameCategory(item.category_id)}</td>
                                    <td className="p-2 border border-[#D4C9BE] text-center">{item.stock}</td>
                                    <td className="p-2 border border-[#D4C9BE] text-center">{item.unit}</td>
